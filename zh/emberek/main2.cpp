...
int A_feladat(int &N, ember emberek[MAXN])
{
    int legidosebb = 0;
    for(int i = 1; i < N ; i++)
    {
...
int B_feladat(int &N, ember emberek[MAXN])
{
    int db = 0;
    for (int i = 0; i < N ; i++)
    {
...
int C_feladat(int &N, ember emberek[MAXN])
{
    int hanyfele=1;
...
void D_feladat(int &N, ember emberek[MAXN])
{
    int szam=0, sorsz[N];
    for(int i=0; i<N; i++)
    {
